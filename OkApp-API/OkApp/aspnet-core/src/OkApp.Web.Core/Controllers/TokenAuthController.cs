...
namespace OkApp.Controllers
{
    ...
    public class TokenAuthController : OkAppControllerBase
    {
        ...
        {
            var tenantName = GetTenancyNameOrNull(model.UserNameOrEmailAddress);
